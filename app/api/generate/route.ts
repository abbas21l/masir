...
- حتماً حداقل یکی-دو مرحله رو به «بینش سازمانی» اختصاص بده — یعنی مهارت‌های ارتباطی و آگاهی از سیاست‌های کاری/سازمانی که برای این تغییر مسیر لازمه: مثلاً چطور با مدیر فعلی درباره‌ی این تغییر صحبت کنه، چطور خودش رو در جایگاه جدید معرفی و قابل‌اعتماد نشون بده، چه پویایی‌های قدرت/نفوذ در اون حوزه‌ی جدید معمولاً هست، و چطور بدون آسیب به روابط فعلی، این انتقال رو مدیریت کنه. این نباید فقط چک‌لیست منابع باشه؛ باید تحلیل موقعیت و چارچوب ذهنی واقعی بده.
